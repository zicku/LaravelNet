		...
		<div class="navbar navbar-inverse navbar-transparent">
			...
			<div class="navbar-collapse collapse" id="navbar-mobile">
				...
				<ul class="nav navbar-nav">
					<li><a href="table_basic.html#">Upgrade</a></li>
				</ul>

				<div class="navbar-right">
					<ul class="nav navbar-nav">
						<li class="dropdown">
							<a href="table_basic.html#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<div class="dropdown-menu dropdown-content">
								<div class="dropdown-content-heading">
									Activity
									<ul class="icons-list">
										<li><a href="table_basic.html#"><i class="icon-menu7"></i></a></li>
									</ul>
								</div>
								...
								<ul class="media-list dropdown-content-body width-350">
									<li class="media">
										<div class="media-left">
											<a href="table_basic.html#" class="btn bg-success-400 btn-rounded btn-icon btn-xs"><i class="icon-mention"></i></a>
										</div>

										<div class="media-body">
											<a href="table_basic.html#">Taylor Swift</a> mentioned you in a post "Angular JS. Tips and tricks"
									...
									<li class="media">
										<div class="media-left">
											<a href="table_basic.html#" class="btn bg-pink-400 btn-rounded btn-icon btn-xs"><i class="icon-paperplane"></i></a>
										</div>
										
										<div class="media-body">
											Special offers have been sent to subscribed users by <a href="table_basic.html#">Donna Gordon</a>
									...
									<li class="media">
										<div class="media-left">
											<a href="table_basic.html#" class="btn bg-blue btn-rounded btn-icon btn-xs"><i class="icon-plus3"></i></a>
										</div>
										
										<div class="media-body">
											<a href="table_basic.html#">Chris Arney</a> created a new <span class="text-semibold">Design</span> branch in <span class="text-semibold">Limitless</span> repository
									...
									<li class="media">
										<div class="media-left">
											<a href="table_basic.html#" class="btn bg-purple-300 btn-rounded btn-icon btn-xs"><i class="icon-truck"></i></a>
										</div>
									...
									<li class="media">
										<div class="media-left">
											<a href="table_basic.html#" class="btn bg-warning-400 btn-rounded btn-icon btn-xs"><i class="icon-bubble8"></i></a>
										</div>
										
										<div class="media-body">
											New review received on <a href="table_basic.html#">Server side integration</a> services
									...
									<li class="media">
										<div class="media-left">
											<a href="table_basic.html#" class="btn bg-teal-400 btn-rounded btn-icon btn-xs"><i class="icon-spinner11"></i></a>
										</div>
							...
							<div class="dropdown-menu dropdown-content width-350">
								...
								<ul class="media-list dropdown-content-body">
									<li class="media">
										...
										<div class="media-body">
											<a href="table_basic.html#" class="media-heading">
						...
						<a class="dropdown-toggle" data-toggle="dropdown">
							@if(Auth::user()->image)
								<img src="{{ asset('storage/photo-user/' . Auth::user()->image) }}" alt="{{ Auth::user()->name }}">
							@else
								<img src="{{ asset('assets/images/placeholder.jpg') }}" alt="{{ Auth::user()->name }}">
							@endif
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="table_basic.html#"><i class="icon-user-plus"></i> My profile</a></li>
								<li><a href="table_basic.html#"><i class="icon-coins"></i> My balance</a></li>
								<li><a href="table_basic.html#"><span class="badge bg-blue pull-right">26</span> <i class="icon-comment-discussion"></i> Messages</a></li>
								<li class="divider"></li>
								<li><a href="table_basic.html#"><i class="icon-cog5"></i> Account settings</a></li>
			...
			<div class="navbar-collapse collapse" id="navbar-second-toggle">
				<ul class="nav navbar-nav navbar-nav-material">
					...
					<li class="dropdown mega-menu mega-menu-wide">
						<a href="table_basic.html#" class="dropdown-toggle" data-toggle="dropdown">Components <span class="caret"></span></a>
							...
							<div class="dropdown-content-body">
								<div class="row">
									<div class="col-md-3">
										...
										<ul class="menu-list">
											<li>
												<a href="table_basic.html#"><i class="icon-pencil3"></i> Form components</a>
												<ul>
													...
													<li>
														<a href="table_basic.html#">Selects</a>
														<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-file-css"></i> JSON forms</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-footprint"></i> Wizards</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-spell-check"></i> Editors</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-select2"></i> Pickers</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-insert-template"></i> Form layouts</a>
												<ul>
									...
									<div class="col-md-3">
										...
										<ul class="menu-list">
											<li>
												<a href="table_basic.html#"><i class="icon-grid"></i> Components</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-browser"></i> Content panels</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-droplets"></i> Content styling</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-gift"></i> Extra components</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-wrench3"></i> Tools</a>
												<ul>
									...
									<div class="col-md-3">
										...
										<ul class="menu-list">
											<li>
												<a href="table_basic.html#"><i class="icon-puzzle4"></i> Extensions</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-popout"></i> JQuery UI</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-upload"></i> File uploaders</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-calendar3"></i> Event calendars</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-sphere"></i> Internationalization</a>
												<ul>
									...
									<div class="col-md-3">
										...
										<ul class="menu-list">
											<li>
												<a href="table_basic.html#"><i class="icon-table2"></i> Basic tables</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-grid7"></i> Data tables</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-alignment-unalign"></i> Data tables extensions</a>
												<ul>
													...
													<li>
														<a href="table_basic.html#">Buttons</a>
														<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-file-spreadsheet"></i> Handsontable</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-versions"></i> Responsive options</a>
												<ul>
					...
					<li class="dropdown mega-menu mega-menu-wide">
						<a href="table_basic.html#" class="dropdown-toggle" data-toggle="dropdown">Features <span class="caret"></span></a>
							...
							<div class="dropdown-content-body">
								<div class="row">
									<div class="col-md-3">
										...
										<ul class="menu-list">
											<li>
												<a href="table_basic.html#"><i class="icon-stack2"></i> Page layouts</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-align-center-horizontal"></i> Fixed width</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-copy"></i> Layouts</a>
												<ul>
													<li><a href="http://office.codigo.id/template/cms/limitless4.1/layout_5/layout_1/LTR/index.html" id="layout1">Layout 1</a></li>
													<li><a href="http://office.codigo.id/template/cms/limitless4.1/layout_5/layout_2/LTR/index.html" id="layout2">Layout 2</a></li>
													<li><a href="http://office.codigo.id/template/cms/limitless4.1/layout_5/layout_3/LTR/index.html" id="layout3">Layout 3</a></li>
													<li><a href="http://office.codigo.id/template/cms/limitless4.1/layout_5/layout_4/LTR/index.html" id="layout4">Layout 3</a></li>
													<li><a href="index.html" id="layout5">Layout 5 <span class="label bg-warning-400">Current</span></a></li>
													<li class="disabled"><a href="http://office.codigo.id/template/cms/limitless4.1/layout_5/layout_6/LTR/index.html" id="layout6">Layout 6 <span class="label bg-slate-300">Coming soon</span></a></li>
												</ul>
											</li>
											<li>
												<a href="table_basic.html#"><i class="icon-droplet2"></i> Color system</a>
												<ul>
											...
											<li><a href="http://office.codigo.id/template/cms/limitless4.1/layout_5/LTR/RTL/index.html"><i class="icon-width"></i> RTL version</a></li>
										</ul>
									</div>
									<div class="col-md-3">
										...
										<ul class="menu-list">
											<li>
												<a href="table_basic.html#"><i class="icon-indent-decrease2"></i> Sidebars</a>
												<ul>
													...
													<li>
														<a href="table_basic.html#">Dual sidebar</a>
														<ul>
													...
													<li>
														<a href="table_basic.html#">Double sidebar</a>
														<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-sort"></i> Vertical navigation</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-transmission"></i> Horizontal navigation</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-paragraph-justify3"></i> Navbars</a>
												<ul>
													<li><a href="navbar_single.html">Single navbar</a></li>
													<li>
														<a href="table_basic.html#">Multiple navbars</a>
														<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-tree5"></i> Menu levels</a>
												<ul>
													<li><a href="table_basic.html#"><i class="icon-IE"></i> Second level</a></li>
													<li>
														<a href="table_basic.html#"><i class="icon-firefox"></i> Second level with child</a>
														<ul>
															<li><a href="table_basic.html#"><i class="icon-android"></i> Third level</a></li>
															<li>
																<a href="table_basic.html#"><i class="icon-apple2"></i> Third level with child</a>
																<ul>
																	<li><a href="table_basic.html#"><i class="icon-html5"></i> Fourth level</a></li>
																	<li><a href="table_basic.html#"><i class="icon-css3"></i> Fourth level</a></li>
																</ul>
															</li>
															<li><a href="table_basic.html#"><i class="icon-windows"></i> Third level</a></li>
														</ul>
													</li>
													<li><a href="table_basic.html#"><i class="icon-chrome"></i> Second level</a></li>
												</ul>
											</li>
										</ul>
									</div>
									<div class="col-md-3">
										...
										<ul class="menu-list">
											<li>
												<a href="table_basic.html#"><i class="icon-graph"></i> Echarts library</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-statistics"></i> D3 library</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-stats-dots"></i> Dimple library</a>
												<ul>
													<li>
														<a href="table_basic.html#">Line charts</a>
														<ul>
													...
													<li>
														<a href="table_basic.html#">Bar charts</a>
														<ul>
													...
													<li>
														<a href="table_basic.html#">Area charts</a>
														<ul>
													...
													<li>
														<a href="table_basic.html#">Step charts</a>
														<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-stats-bars"></i> C3 library</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-google"></i> Google visualization</a>
												<ul>
									...
									<div class="col-md-3">
										...
										<ul class="menu-list">
											...
											<li>
												<a href="table_basic.html#"><i class="icon-spinner10 spinner position-left"></i> Velocity animations</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-map5"></i> Maps integration</a>
												<ul>
													<li>
														<a href="table_basic.html#">Google maps</a>
														<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-magazine"></i> Timelines</a>
												<ul>
											...
											<li>
												<a href="table_basic.html#"><i class="icon-thumbs-up2 position-left"></i> Icons</a>
												<ul>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu width-250">
							...
							<li class="dropdown-submenu">
								<a href="table_basic.html#"><i class="icon-task"></i> Task manager</a>
							...
							<li class="dropdown-submenu">
								<a href="table_basic.html#"><i class="icon-cash3"></i> Invoicing</a>
								<ul class="dropdown-menu width-200">
									<li class="dropdown-header highlight">Options</li>
							...
							<li class="dropdown-submenu">
								<a href="table_basic.html#"><i class="icon-people"></i> User pages</a>
								<ul class="dropdown-menu width-200">
							...
							<li class="dropdown-submenu">
								<a href="table_basic.html#"><i class="icon-user-plus"></i> Login &amp; registration</a>
								<ul class="dropdown-menu width-200">
									<li class="dropdown-header highlight">Basic</li>
							...
							<li class="dropdown-submenu">
								<a href="table_basic.html#"><i class="icon-search4"></i> Search</a>
								<ul class="dropdown-menu width-200">
									<li class="dropdown-header highlight">Basic</li>
							...
							<li class="dropdown-submenu">
								<a href="table_basic.html#"><i class="icon-images2"></i> Gallery</a>
								<ul class="dropdown-menu width-200">
									<li class="dropdown-header highlight">Options</li>
							...
							<li class="dropdown-submenu">
								<a href="table_basic.html#"><i class="icon-lifebuoy"></i> Support</a>
								<ul class="dropdown-menu width-200">
							...
							<li class="dropdown-submenu">
								<a href="table_basic.html#"><i class="icon-warning"></i> Error pages</a>
								<ul class="dropdown-menu width-200">
									<li class="dropdown-header highlight">Options</li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu width-200">
							...
							<li class="dropdown-submenu">
								<a href="table_basic.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-grid2"></i> Columns</a>
								<ul class="dropdown-menu">
									<li class="dropdown-header highlight">Options</li>
									<li><a href="starters/1_col.html">One column</a></li>
									<li><a href="starters/2_col.html">Two columns</a></li>
									<li class="dropdown-submenu">
										<a href="table_basic.html#">Three columns</a>
										<ul class="dropdown-menu">
							...
							<li class="dropdown-submenu">
								<a href="table_basic.html#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-paragraph-justify3"></i> Navbars</a>
								<ul class="dropdown-menu">
				...
				<ul class="nav navbar-nav navbar-nav-material navbar-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-right">
							<li><a href="table_basic.html#"><i class="icon-user-lock"></i> Account security</a></li>
							<li><a href="table_basic.html#"><i class="icon-statistics"></i> Analytics</a></li>
							<li><a href="table_basic.html#"><i class="icon-accessibility"></i> Accessibility</a></li>
							<li class="divider"></li>
							<li><a href="table_basic.html#"><i class="icon-gear"></i> All settings</a></li>
						</ul>
					</li>
				</ul>
			</div>
				...
				<ul class="fab-menu-inner">
					<li>
						<div data-fab-label="Compose email">
							<a href="table_basic.html#" class="btn btn-default btn-rounded btn-icon btn-float">
					...
					<li>
						<div data-fab-label="Chat with Jack">
							<a href="table_basic.html#" class="btn bg-pink-400 btn-rounded btn-icon btn-float">
	...
	<div class="navbar navbar-default navbar-fixed-bottom footer">
		...
		<div class="navbar-collapse collapse" id="footer">
			<div class="navbar-text">
				&copy; 2015. <a href="table_basic.html#" class="navbar-link">Limitless Web App Kit</a> by <a href="http://themeforest.net/user/Kopyov" class="navbar-link" target="_blank">Eugene Kopyov</a>
			</div>

			<div class="navbar-right">
				<ul class="nav navbar-nav">
					<li><a href="table_basic.html#">About</a></li>
					<li><a href="table_basic.html#">Terms</a></li>
					<li><a href="table_basic.html#">Contact</a></li>
				</ul>
			</div>
		</div>
	</div>
